		...
		<div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
			...
			<form onSubmit={onSubmit} className="space-y-4">
				...
				<div className="flex gap-3">
					...
					<button type="button" onClick={() => router.back()} className="rounded-md border border-zinc-300 px-4 py-2 text-sm font-semibold hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-900">Batal</button>
				</div>
			</form>
		</div>
	);
