			...
			<form onSubmit={onSubmit} className="space-y-4 rounded-lg border border-zinc-200 p-6 dark:border-zinc-800">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
					<label className="block text-sm">ID
						<input disabled className="mt-1 w-full rounded-lg border border-zinc-300 bg-zinc-100 p-2 dark:border-zinc-700 dark:bg-zinc-900" value={form.id} readOnly />
					</label>
					<label className="block text-sm sm:col-span-2">Judul
						<input className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} required />
					</label>
					<label className="block text-sm">Harga (IDR)
						<input type="number" className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.price} onChange={(e) => setForm({ ...form, price: e.target.value })} required />
					</label>
					<label className="block text-sm">Harga Asli (opsional)
						<input type="number" className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.originalPrice} onChange={(e) => setForm({ ...form, originalPrice: e.target.value })} />
					</label>
					<label className="block text-sm">Kategori Produk
						<select className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} required>
					...
					<label className="block text-sm">Kategori Navigasi
						<select className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.navCategory} onChange={(e) => setForm({ ...form, navCategory: e.target.value })} required>
					...
					<label className="block text-sm">Stok
						<input type="number" className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.stock} onChange={(e) => setForm({ ...form, stock: e.target.value })} required />
					</label>
					...
					<label className="block text-sm sm:col-span-2">Deskripsi
						<textarea className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" rows={4} value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} />
					</label>
					<label className="block text-sm">Badge (opsional)
						<select className="mt-1 w-full rounded-lg border border-zinc-300 bg-white p-2 dark:border-zinc-700 dark:bg-zinc-950" value={form.badge} onChange={(e) => setForm({ ...form, badge: e.target.value })}>
